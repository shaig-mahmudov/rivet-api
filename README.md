...
## Repositories
- **Backend Repository (API)**: [https://github.com/shaig-mahmudov/rivet-api](https://github.com/shaig-mahmudov/rivet-api)
- **Frontend Repository (Web)**: [https://github.com/shaig-mahmudov/rivet-web](https://github.com/shaig-mahmudov/rivet-web)
...
- When deploying to production (e.g. Koyeb), configure `CORS_ALLOWED_ORIGINS` (e.g. `https://rivet-eta.vercel.app`) to restrict cross-origin requests.
